...
#define DokanAllocNPaged(size) ExAllocatePoolWithTag(NonPagedPool, size, TAG)

inline PVOID DokanAllocNPagedZero(SIZE_T size) {
  PVOID buffer = DokanAllocNPaged(size);
